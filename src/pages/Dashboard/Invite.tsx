...
import { Copy, Trophy, Medal, UserPlus, Users, ChevronUp, ChevronDown } from 'lucide-react'
import {
  Table,
  TableBody,
  TableCaption,
        ...
        <CardContent>
          <div className="flex flex-col sm:flex-row gap-4 items-center">
            <div className="relative w-full">
              <div className="absolute inset-0 bg-gradient-to-r from-secondary/20 to-blue-600/20 blur-xl opacity-30"></div>
              <div className="relative flex items-center justify-between bg-blue-900/50 rounded-lg border border-white/10 p-4 w-full">
                <div>
                  <p className="text-xs text-blue-300 mb-1">Share this code with friends</p>
            ...
            <div className="flex flex-col items-center gap-2 bg-blue-900/50 rounded-lg border border-white/10 p-4 w-full sm:w-auto">
              <p className="text-sm text-blue-300">Referral Link</p>
              <Button 
                variant="outline" 
                className="w-full border-white/20 text-white hover:bg-blue-800/50"
                onClick={() => {
                  navigator.clipboard.writeText(`https://urkelcodes.com/invite/${referralCode}`)
                  toast({
                    title: "Copied to clipboard",
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 rounded-lg bg-blue-900/30 p-4 border border-white/5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-blue-300">Invite friends to earn more points</p>
              </div>
            </div>
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-blue-900/50 hover:bg-blue-900/50">
                  ...
                  <TableHead className="text-blue-300">Invites</TableHead>
                  ...
                  >
                    ...
                    <TableCell>
                      <div className="flex items-center gap-2">
                        ...
                        {index === 3 && (
                          <span className="text-xs bg-blue-900/50 px-2 py-0.5 rounded text-blue-300">You</span>
                        )}
                      </div>
                    </TableCell>
              ...
              <TableCaption className="text-blue-300">
          ...
          <div className="mt-6 rounded-lg bg-blue-900/30 p-4 border border-white/5">
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-blue-300">Share your referral code with more friends to increase your rank</p>
              </div>
