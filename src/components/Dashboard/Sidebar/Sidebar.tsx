...
const Sidebar: React.FC = () => {
  ...
  return (
    <div className="w-[72px] hover:w-[200px] border-r h-[100vh] flex-col gap-6 bg-white items-center justify-center px-2 sticky top-0 left-0 group transition-all duration-500 hidden md:flex">
      {navs.map((nav, index) => (
        <Link
          to={nav.path}
          key={index}
