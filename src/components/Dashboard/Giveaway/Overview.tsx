...
import { useJoinGiveaway } from "@/api/mutations";
...
const giveawayTips = [
  {
    ...
    content:
      "Stay active and complete tasks regularly to increase your chances.",
    icon: CheckCircle,
  ...
  },
  {
    ...
    content:
      "Users with consistent platform engagement have higher chances of winning.",
    icon: Star,
  ...
  },
  {
    ...
    content:
      "Invite your friends to join KlikkUp and boost your winning chances.",
    icon: UsersIcon,
    color: "text-blue-400",
  },
];
...
const isGiveawayActive = !data?.none;
  const { mutate } = useJoinGiveaway();
      ...
      <GradientCard>
        <CardContent className="text-center p-12">
          ...
          <h2 className="text-3xl font-bold text-white mb-4">
            No Giveaway At the Moment
          </h2>
          <p className="text-white/80 text-lg">
            Check back later for new giveaway announcements!
          </p>
        </CardContent>
      </GradientCard>
    );
          ...
          <CardContent className="text-center p-12">
            ...
            >
              ...
              <h1 className="text-5xl font-bold text-white mb-3 bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">
                ₦{Number(data?.prize).toLocaleString()}
              </h1>
              <p className="text-2xl text-white/90 mb-2">{data?.title}!</p>
              <p className="text-white/70 mb-8 text-lg">
                For All Active KlikkUp Users
              </p>
              ...
              <Button
                ...
                onClick={() => {
                  mutate(undefined, {
                    onSuccess: () => {
                        queryClient.invalidateQueries({ queryKey: ["active-giveaway"] })
                      toast.success(
                        "You have successfully participated in giveaway"
                      );
                    },
                  });
                }}
          ...
          <CardContent className="p-8">
            <div className="text-center mb-6">
              ...
              <p className="text-white/70">
                You're competing with thousands of users for the grand prize!
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-center p-6 bg-white/5 rounded-xl border border-white/10">
                ...
                <h3 className="text-xl font-bold text-white mb-1">
                  ₦{formatShortMoney(Number(data?.prize))}
                </h3>
              </div>
          ...
          <CardContent className="p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-white/70 text-lg">
                Follow these tips to maximize your chances of winning
              </p>
            </div>
