  ...
  return (
    <MainPadding className="bg-gradient-to-br from-primary via-primary/80 to-secondary/50 relative">
      <motion.div
          ...
          transition={{ repeat: Number.POSITIVE_INFINITY, repeatType: "reverse", duration: 20, ease: "linear" }}
          style={{
            backgroundImage:
      ...
      <div className="relative overflow-hidden">
        <div className="relative z-10 text-white text-center py-16 px-4 sm:px-8">
          <motion.div initial="initial" animate="animate" className="flex flex-col gap-8 items-center justify-center">
            <div className="flex justify-center items-center gap-4 sm:gap-8">
              <motion.div variants={iconVariants} className="bg-white rounded-full p-3 sm:p-4">
            ...
            <motion.div variants={textVariants} className="space-y-2">
              <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold fancy-font">Klikk. Earn. Repeat!</h2>
              <p className="text-lg sm:text-xl md:text-2xl max-w-2xl mx-auto mt-4">
                Don't just consume content – get rewarded for it. Sign up and start farming now!
              </p>
            </motion.div>
            <motion.div variants={textVariants} className="flex flex-wrap gap-4 items-center justify-center mt-6">
              <motion.button
