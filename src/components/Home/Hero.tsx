...
const Hero: React.FC = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row  gap-5 items-center justify-center py-10 text-foreground relative">
      <div className="hidden w-[800px] h-[800px] border border-primary shadow-2xl shadow-primary/80 rounded-full flex items-center justify-center  absolute top-0 left-1/2 translate-x-[-50%] translate-y-[5%]  animate-pulse -z-10">
