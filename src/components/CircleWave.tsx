...
const CircleWave: React.FC<CircleWavaProps> = ({ className }) => {
  return (
    <div>
      <div className={cn(
        "hidden w-[800px] h-[800px] border border-primary shadow-2xl shadow-primary/80 rounded-full md:flex items-center justify-center  absolute top-0 left-1/2 translate-x-[-50%] translate-y-[5%]  animate-pulse -z-10",
        className
      )}>
